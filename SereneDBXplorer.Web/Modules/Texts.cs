    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your SereneDBXplorer Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your SereneDBXplorer Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "SereneDBXplorer";
        }
